...
- M1 is active on `loop/m1-process-streaming`. The first bounded direct-process/streaming slice is locally verified and independently reviewed; PR/CI/merge and later M1 lifecycle slices remain pending.
